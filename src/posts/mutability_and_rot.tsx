  ...
  children: (
    <>
      ...
      <P>
        ...
        solution, however, since a link to the internet archive can rot just
        like any other link. The archivists best intentions do not protect
        against{" "}
      ...
      <P>
        ...
        <Em>the</Em>{"  "}
        core mechanism for hyperlinking, something would be lost. When I link to
        {" "}
        <A href="https://gwil.garden/">a friend’s website</A>, I know that
        readers will always get the up-to-date version. With a snapshot, the
        majority of readers would get a stale and incomplete version.
      </P>

      <P>
        Personal websites, blogs and microblogs, forums, and the connections
        between all of these — indeed most facets of the web that make it feel
        worthwhile, alive, and human to me — rely on content changing over time.
        Whenever a project promises to deliver{" "}
        ...
        are worthwhile engineering feats in their own, but they serve different
        needs than the web.
      </P>

      <P>
        A quick look at the current landscape of popular distributed systems can
        make this look like a dilemma: systems which introduce mutability seem
        to invariably be plagued by link rot. It can feel like either you
        embrace active mutability at the cost of passive link rot,<Marginale>
      ...
      >
        ...
        <P>
          ...
          data by its name (i.e., its secure hash) is convenient and efficient,
          but otherwise semantically equivalent to supplying a verbatim copy of
          the referenced data. The notion of deleting data that somebody else is
          referencing makes little sense; if the other person had copied your
          data verbatim into their own data, you would not expect to be able to
          selectively delete those sections either. Another obvious technical
          limitation is the impossibility of cyclic{" "}
          <Sidenote
            note={
              <>
      ...
      >
        <P>
          ...
          running at that address is contacted and asked for its data.
        </P>
          ...
          <Sidenote
            note={
              <>
                ...
                by over time mapping the same URL to different IP addresses
                serving different content. Using this mechanism for updating
                content is so unidiomatic that I will disregard it.
        ...
        <P>
          ...
          resource. The DNS rents out names on a per-year basis. If you stop
          paying, all links to your site will stop working. This all but
          guarantees link rot! From this, we can derive several necessary
          conditions for avoiding link rot:<Marginale>
            ...
            a contact on your phone. Petnames are inherently subjective, though
        ...
        <P>
          ...
          of name resolution on the web takes place: the user agent contacts the
          server at the given IP address, and the server returns the data it
          stores at that point in time. This is the primary mechanism for
          mutability on the web: the same server can store and return different
          data at different points in time.
        </P>

        <P>
          This location-based mutability is analogous to imperative programming:
          a variable name compiles down to a physical memory address on a
          computer. Whenever a program access the value of a variable, the
          computer supplies the current value stored at the corresponding
          address.
        </P>

        <P>
          In a distributed system, location-based name resolution inherently
          leads to link rot.<Marginale>
            ...
            watch large parts of it be swallowed by link rot over the next
            decades.
          </Marginale>{" "}
      ...
      >
        <P>
          ...
          <Sidenote
            note={
              <>
                I personally have first encountered this technique in{" "}
                ...
                as inspiration. It seems safe to say that this technique has
                been and will be reinvented several times, but I am not aware of
                a common name for it. So I am giving it one simply to make
                writing this post more convenient.
              </>
            }
          >
            call
        ...
        <P>
          The choice of timestamps can have far-reaching consequences. Of
          particular interest are single-writer versus multi-writer properties.
          With wall-clock timestamps,<Marginale>
        ...
        <P>
          ...
          the relevant information on how to resolve it. Systems built on signed
        ...
        <P>
          ...
          the peer who gives you the data. Introducing intermediaries does open
          up questions of freshness. Did you get up-to-date data bound to the
          name, or is the data stale?{" "}
          <Sidenote
            note={
              <>
                A prominent exception is{" "}
                <A href="https://en.wikipedia.org/wiki/Nostr">Nostr</A>, which
                does not even guarantee <Em>eventual</Em> consistency.
              </>
            }
          >
            Typically
        ...
        <P>
          ...
          well. In particular, you could annotate names with the (IP) address of
          a recommended data source to contact for resolution.<Marginale>
          ...
          systems while the recommended server is online, and would fail
          gracefully to a slower but more resilient resolution mechanism to
          prevent link rot.
        </P>
        ...
        <P>
          ...
          <Em>binding</Em>{" "}
          itself lasts as long as its digital signature scheme remains secure.
        </P>
      ...
      <P>
        ...
        solutions to important concerns: censorship-resistant<Marginale>
          In my following arguments in favour of mutable names, it is crucial
          that mutable approaches need not suffer from passive link rot either —
          otherwise, their benefits would be counteracted by lack of durability
          and resilience, and we would end up comparing apples and oranges.
        </Marginale>{" "}
      ...
      <P>
        <Marginale>
          Publishing always sacrifices <Em>some</Em>{" "}
        ...
        When I publish a <Em>mutable</Em>{" "}
        link to some data, I give agency to the author of that data. They are
        free to change the contents in the future, or even to fully remove the
        data. Like a verbatim copy, an <Em>immutable</Em>{" "}
        link would not award this agency.
      </P>

      <P>
        By granting this agency, I voluntarily cede control. The quality of my
        work will vary based on the future actions of another human. A web of
        mutable references is a web of human interdepence, and builds on the
        voluntary giving of trust.
      </P>

      <P>
        Freely given trust and consensual interdependence are deeply human, they
        sit at the root of the most positive relationships we can form. I want
      ...
      <P>
        ...
        trust must never be without alternative. I <Em>can</Em> choose to{" "}
        <Sidenote
          note={
            <>
              Or, ideally, I would be able to refer to the content via
              content-addressing, which has much better usability.
            </>
          }
        >
          copy
      ...
      <P>
        I imagine that the vocal proponents of eliminating as much trust from
        ...
        >
          trust
        </Sidenote>. Such indiscriminate opposition to <Em>all</Em>{" "}
        (giving of) trust makes me quite sad. Instead, I want to see systems
        that minimise involuntary, coerced trust, while simultaneously
        maximising opportunities for voluntarily granting trust.
      </P>

      <P>
        And that is why I, like anybody would, decided to write a post on
        mutable name bindings.
      </P>
      ...
      <P>
        ...
        the most. But there are numerous other important issues as well, and
        things are rarely black and white. The inability to retract one’s
        material can{" "}
        <A href="https://newdesigncongress.org/en/pub/this-is-fine/">
          cause harm
        </A>. But deletion of publicly valuable information can <Em>also</Em>
        {" "}
        <A href="https://www.bbc.com/news/articles/cgkj8gx1vy6o">cause harm</A>.
        Sometimes, active moderation of content by parties other than the
        authors could{" "}
        <A href="https://erinkissane.com/meta-in-myanmar-full-series">
          prevent harm
        </A>. Immutability can support accountability, can counteract
      ...
      <P>
        ...
        <Sidenote
          note={
            <>
              And I <Em>wish</Em>{" "}
              the academic computer science community would stop pretending
              otherwise.
            </>
          }
        >
      ...
      <P>
        ...
        mutation, should receive more attention. How widely can they be
        deployed? How accessible can they be, and to whom? How can we categorise
        different offshoots, how can we explore, chart, and analyse the design
