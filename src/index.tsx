...
import { A, Div, H, H2, H4, Hr, Img, Li, Nav, P, Ul } from "macromania-html";
import { ConfigDefref, R } from "macromania-defref";
...
import { ConfigPreviews, CssDependency } from "macromania-previews";
      ...
      <Path fill="#fff" d="M0 960l951 945L0 2850z" />
        ...
        <Div clazz="columns2">
          <Div>
            ...
            >
              <P>
                ...
                such as{" "}
                <A href="https://g-trees.github.io/g_trees/">this one</A>. And
                the website you are currently reading, of course.
              </P>
            </Card>
          ...
          <Div>
            ...
            >
              <P>
                Range-based set reconciliation is a simple approach to
                efficiently computing the union of two sets over a network,
                based on recursively partitioning the sets and comparing
                fingerprints of the partitions to probabilistically detect
                whether a partition requires further work. Several open source
                projects <A href="https://logperiodic.com/rbsr.html">started</A>
                {" "}
            ...
            >
              <P>
                ...
                principled work on evaluating them. Starting from the question
                of how to objectively evaluate such APIs, I derive some
                instructive and useful hierarchies of interfaces for lazily
